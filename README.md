# Agentic Surveillance MX — Privacy Violation Experiment

> Adapting ODCV-Bench legal scenarios with AgentSocialBench surveillance metrics  
> to study whether language, legal framework, and cultural context affect  
> AI agent compliance with privacy restrictions in a Mexican context.

## Project Structure

```
agentic-surveillance-mx/
├── scenarios/              ← 16 scenario dirs (4 base × 4 conditions), ODCV-compatible
│   ├── E1-Banking-Control/
│   ├── E1-Banking-T1/
│   ├── ...
│   └── E4-DataAccess-T3/
